...
Config.Text = {
	SitOnChair = '~g~G~w~ para sentar',
	SitOnBed = '~g~E~w~ para sentar na cama',
	LieOnBed = '~g~E~w~ para deitar na cama',
	SwitchBetween = '~w~ Mudar entre barriga, costas e sentar com as ~g~setas',
	Standup = '~g~F~w~ para levantar!'
}